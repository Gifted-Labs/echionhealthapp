...
/**
 * Controller for collaboration and Sono Share features
 */
@RestController
@RequestMapping("/collaboration")
@RequiredArgsConstructor
@Tag(name = "Collaboration", description = "Scan sharing and collaboration APIs")
public class CollaborationController {
    ...
    @PostMapping("/share")
    @Operation(summary = "Share scan", description = "Share a scan for peer review")
    ...
    @Operation(summary = "Scans shared with me", description = "Get scans shared with the current user")
    ...
    @Operation(summary = "My shared scans", description = "Get scans I've shared")
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Get shared scan", description = "Get details of a shared scan")
    ...
    @Operation(summary = "Add comment", description = "Add a comment or feedback to a shared scan")
    ...
    @Operation(summary = "Get comments", description = "Get comments for a shared scan")
    ...
    @Operation(summary = "Resolve scan", description = "Mark a shared scan as resolved")
